...
type AddRequest struct {
	...
	A             int32                  `protobuf:"varint,1,opt,name=a,proto3" json:"a,omitempty"` // First number
	B             int32                  `protobuf:"varint,2,opt,name=b,proto3" json:"b,omitempty"` // Second number
...
type AddResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Result        int32                  `protobuf:"varint,1,opt,name=result,proto3" json:"result,omitempty"` // Sum of a and b
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_calculator_proto_rawDesc = "" +
	...
	"\n" +
	"Calculator\x128\n" +
	"\x03Add\x12\x16.calculator.AddRequest\x1a\x17.calculator.AddResponse\"\x00B\x0fZ\r./proto;protob\x06proto3"
